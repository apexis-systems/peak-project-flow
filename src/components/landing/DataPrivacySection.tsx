      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-3xl text-center">
        <AnimatedSection>
          <div className="w-14 h-14 rounded-xl border border-border/60 bg-card flex items-center justify-center mx-auto mb-8">
            <Lock className="w-6 h-6 text-foreground/60" strokeWidth={1.5} />
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mt-10">
            <Shield className="w-4 h-4 text-muted-foreground/40" strokeWidth={1.5} />
            <span className="text-xs text-muted-foreground font-light">End-to-end encrypted · Role-based access · SOC 2 compliant</span>
          </div>
        </AnimatedSection>
      </div>
    </section>
