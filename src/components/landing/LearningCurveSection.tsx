    ...
    <section className="py-32 lg:py-40">
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl text-center">
        <AnimatedSection>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed font-light mb-16">
              ...
              <div key={step.label} className="flex items-center gap-4 sm:gap-8">
                ...
                >
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl border border-border/60 bg-card flex items-center justify-center">
                    <step.icon className="w-6 h-6 sm:w-7 sm:h-7 text-foreground/60" strokeWidth={1.5} />
                  </div>
