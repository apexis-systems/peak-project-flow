      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
        <AnimatedSection className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-muted-foreground leading-relaxed font-light">
            Serious construction projects require serious systems. <span className="font-bold" style={{ color: '#f97415' }}>APEXIS</span> is designed with the same reliability expectations as enterprise software platforms.
          </p>
        </AnimatedSection>
