  ...
  return (
    <section id="about" className="py-32 lg:py-40">
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
        <AnimatedSection>
          <span className="text-xs font-medium tracking-widest uppercase text-muted-foreground mb-6 block">About <span className="font-bold" style={{ color: '#111111' }}>APEXISpro</span></span>
