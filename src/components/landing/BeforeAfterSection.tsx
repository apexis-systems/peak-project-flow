      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
        <AnimatedSection className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight leading-[1.1]">
            Before <span className="font-bold" style={{ color: '#111111' }}>APEXISpro</span> vs <span className="font-bold" style={{ color: '#111111' }}>After APEXISpro</span>
          </h2>
        </AnimatedSection>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <AnimatedSection>
            ...
            >
              <h3 className="font-display font-bold text-lg mb-8 text-foreground/70">Before <span className="font-bold" style={{ color: '#111111' }}>APEXISpro</span></h3>
          ...
          <AnimatedSection delay={0.15}>
            ...
            >
              <h3 className="font-display font-bold text-lg mb-8" style={{ color: '#f97415' }}>After APEXISpro</h3>
              <div className="space-y-5">
                {after.map((item) => (
                  <div key={item} className="flex items-start gap-3 pb-5 border-b border-border/40 last:border-0 last:pb-0">
